...
I'm just removing the gradslam dependency to make EfficientGraphs easier to install.
...
from EfficientGraph.dataset import EfficientGraphs_datautils
from EfficientGraph.utils.geometry import relative_transformation
from EfficientGraph.dataset.EfficientGraphs_rgbd_images import RGBDImages


from EfficientGraph.utils.general_utils import measure_time
...
class GradSLAMDataset(torch.utils.data.Dataset):
    ...
    def _preprocess_color(self, color: np.ndarray):
        ...
        if self.normalize_color:
            color = EfficientGraphs_datautils.normalize_image(color)
        if self.channels_first:
            color = EfficientGraphs_datautils.channels_first(color)
        return color
    ...
    def _preprocess_depth(self, depth: np.ndarray):
        ...
        if self.channels_first:
            depth = EfficientGraphs_datautils.channels_first(depth)
    ...
    def __getitem__(self, index):
        ...
        K = EfficientGraphs_datautils.scale_intrinsics(
